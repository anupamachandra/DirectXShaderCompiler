...
enum class OpCode : unsigned {
  ...
  MatVecMul = 303, // Matrix-Vector Multiply
  MatVecMulAdd = 304, // Matrix-Vector Multiply Add

  // Linear Algebra Intrinsics Training
  OuterProductAccumulate = 305, // Outer Product Accumulate
  VectorAccumulate = 306, // Vector Accumulate
  ...
  NumOpCodes = 307 // exclusive last value of enumeration
};
// OPCODE-ENUM:END
